...
import { getISTDate, formatIST } from "@/lib/utils";
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (data.occasionDate) {
                        const dateStr = formatIST(data.occasionDate, "yyyy-MM-dd");
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="text-right">
                            <p className="text-slate-900 font-mono font-bold text-sm tracking-widest">
                                {formatIST(event.occasionDate, "yyyyMMdd")}-{event.mobile}
                            </p>
                            <p className="text-slate-400 text-[10px] mt-1">Digitally generated by Secunderabad Jamaat on {formatIST(new Date(), "EEEE, PPP p")}</p>
                        </div>
                    </div>
                </div >
